...
// name attribute from the HTML form where the information was entered.
$event_name = $_POST[presenter_first_name];
...
// Do not use any returns or this will break.
	$sqlHardCode = "INSERT INTO presenters (presenter_first_name, presenter_last_name, presenter_city, presenter_st, presenter_zip, presenter_email) VALUES ($presenter_first_name, $presenter_last_name, $presenter_city, $presenter_st, $presenter_zip, $presenter_email);";
